...
> Personal debugging assistant. Paste any stack trace, get a clear explanation tailored to your level — **Novice**, **Mid**, or **Expert** — with corrected code and syntax highlighting. Open a multi-turn chat with context pre-loaded, save analyses to a **vault**, and track error patterns over time. Supports **6 AI providers** (Groq, OpenRouter, Ollama, Anthropic, OpenAI, VeniceAI) including free tiers. API keys stored in OS keychain. **100% local by default.**
...
> Instant offline translation from any app's text-selection menu. Integrates with Android's `ACTION_PROCESS_TEXT` for fast in-place translations (ES ↔ EN) using on-device NMT. No cloud, no tracking, no data leaves your device.
...
> Self-updating domain tracker for **Anna's Archive** and shadow libraries. Crawls Reddit, X, Telegram and Mastodon to discover new mirrors, verifies them bypassing Cloudflare, and publishes an immutable report to **IPFS via Pinata** every 6 hours.
...
> Desktop version of ThreadsVault. Improved UI/UX, same privacy-first philosophy. Available for Windows (.exe / .msi) and Linux (.AppImage / .deb).
...
> Local vault for Android to save, organize and preserve Threads posts outside the platform. Stores links, notes, categories and metadata in a private on-device database. No account, no cloud, no tracking.
...
> Price comparison app for Gran Canaria residents. Scan products, compare prices across supermarkets, and contribute to a community-maintained database. Built in response to continuous price increases across the island.
...
![Kotlin](https://img.shields.io/badge/Kotlin-000000?style=flat-square&logo=kotlin&logoColor=00FF41)
![TypeScript](https://img.shields.io/badge/TypeScript-000000?style=flat-square&logo=typescript&logoColor=3178C6)
![JavaScript](https://img.shields.io/badge/JavaScript-ES6-000000?style=flat-square&logo=javascript&logoColor=00FF41)
![Python](https://img.shields.io/badge/Python-000000?style=flat-square&logo=python&logoColor=00FF41)
![Shell](https://img.shields.io/badge/Shell-000000?style=flat-square&logo=gnu-bash&logoColor=00FF41)
...
![Android Studio](https://img.shields.io/badge/Android_Studio-000000?style=flat-square&logo=android-studio&logoColor=00FF41)
![VS Code](https://img.shields.io/badge/VS_Code-000000?style=flat-square&logo=visual-studio-code&logoColor=00FF41)
![VSCodium](https://img.shields.io/badge/VSCodium-000000?style=flat-square&logo=vscodium&logoColor=00FF41)
![Antigravity IDE](https://img.shields.io/badge/Antigravity_IDE-000000?style=flat-square&logo=jetbrains&logoColor=00FF41)
